                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data.success){
                            ...
                            html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #ff0000;" onclick="editRemark(\''+data.ar.id+'\')"></span></a>'
                            html+='&nbsp;&nbsp;&nbsp;&nbsp;'
                            html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #ff0000;" onclick="removeRemark(\''+data.ar.id+'\')"></span></a>'
                            html+='</div>'
                            html+='</div>'
                            html+='</div>'
